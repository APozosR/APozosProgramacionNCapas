...
namespace DL_EF
{
    ...
    public partial class APozosProgramacionNCapasEntities : DbContext
    {
        public APozosProgramacionNCapasEntities()
            : base("name=APozosProgramacionNCapasEntities")
        {
        }
        ...
        public virtual int UsuarioAdd(string nombre, string apellidoPaterno, string apellidoMaterno, string telefono, Nullable<byte> idRol, string userName, string email, string password, string fechaNacimiento, string sexo, string celular, string cURP, string imagen, Nullable<bool> status, string calle, string numeroInterior, string numeroExterior, Nullable<int> idColonia)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioAdd", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, telefonoParameter, idRolParameter, userNameParameter, emailParameter, passwordParameter, fechaNacimientoParameter, sexoParameter, celularParameter, cURPParameter, imagenParameter, statusParameter, calleParameter, numeroInteriorParameter, numeroExteriorParameter, idColoniaParameter);
        }
        ...
        public virtual int UsuarioUpdate(Nullable<int> idUsuario, string nombre, string apellidoPaterno, string apellidoMaterno, string telefono, Nullable<byte> idRol, string userName, string email, string password, string fechaNacimiento, string sexo, string celular, string cURP, string imagen, Nullable<bool> status, Nullable<int> idDireccion, string calle, string numeroInterior, string numeroExterior, Nullable<int> idColonia)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioUpdate", idUsuarioParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, telefonoParameter, idRolParameter, userNameParameter, emailParameter, passwordParameter, fechaNacimientoParameter, sexoParameter, celularParameter, cURPParameter, imagenParameter, statusParameter, idDireccionParameter, calleParameter, numeroInteriorParameter, numeroExteriorParameter, idColoniaParameter);
        }
    }
}
